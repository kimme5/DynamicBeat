...
public class Game extends Thread {
	...
	private Image judgeSImage;
	private Image judgeDImage;
	...
	public void screenDraw(Graphics2D g) {
		...
		for(int i = 0; i < noteList.size(); i++) {
			...
			if(note.getY() > 620) {
				judgeSImage = new ImageIcon(Main.class.getResource("/images/judgeMiss.png")).getImage();
				judgeSImage = new ImageIcon(Main.class.getResource("/images/judgeMiss.png")).getImage();
			}
		...
		g.drawImage(blueFlareImage, 350, 300, null);
		g.drawImage(judgeSImage, 170, 320, null);
	...
	public void releaseS() {
		...
		judgeSImage = new ImageIcon(Main.class.getResource("/images/judgeReleased.png")).getImage();
	}
...
//	}
	...
	public void judgeEvent2(String input, String judge) {
		...
		if(input.equals("S")) {
			...
			if(judge.equals("Miss")) {
				...
				judgeSImage = new ImageIcon(Main.class.getResource("/images/judgeEarly.png")).getImage();
			} else if(judge.equals("Good")) {
				judgeSImage = new ImageIcon(Main.class.getResource("/images/judgeGood.png")).getImage();
			} else if(judge.equals("Great")) {
				judgeSImage = new ImageIcon(Main.class.getResource("/images/judgeGreat.png")).getImage();
			} else if(judge.equals("Perfect")) {
				judgeSImage = new ImageIcon(Main.class.getResource("/images/judgePerfect.png")).getImage();
			} else if(judge.equals("Late")) {
				judgeSImage = new ImageIcon(Main.class.getResource("/images/judgeLate.png")).getImage();
			}	
		}
